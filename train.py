        ...
        if RANK in {-1, 0}:
            ...
            if (not nosave) or (final_epoch and not evolve):  # if save
                ...
                if best_fitness == fi:
                    ...
                    drive_save_path = '/content/drive/MyDrive/Flashaid/Signature/best.pt' 
                    shutil.copy(last, drive_save_path)
                if opt.save_period > 0 and epoch % opt.save_period == 0:
                    torch.save(ckpt, w / f"epoch{epoch}.pt")
                drive_save_path = '/content/drive/MyDrive/Flashaid/Signature/last.pt'
                shutil.copy(last, drive_save_path)  # Copy last.pt to Google Drive at every epoch
                del ckpt
